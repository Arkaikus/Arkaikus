...
### Backend & Languages
[![Backend](https://skillicons.dev/icons?i=python,django,fastapi,go,php,ruby,java,cpp)]()

### Frontend
[![Frontend](https://skillicons.dev/icons?i=react,javascript,typescript,html,css,tailwind,bootstrap)]()

### ML & AI
[![ML](https://skills.syvixor.com/api/icons?perline=15&i=pytorch,langchain,chroma,openwebui,jupyter,pandas)]()

### DevOps & Cloud
[![DevOps](https://skillicons.dev/icons?i=docker,kubernetes,cloudflare,git,github,bitbucket)]()
...
Currently leading a remote engineering team as **Senior Python Team Lead**.

- 📈 Tracking team progress, removing blockers, and ensuring timely delivery.
- 🛡️ Maintaining code quality via regular reviews and proactive bug fixes.
- 🗣️ Collaborating with product stakeholders to align engineering with business standards.
- 🐍 Leveraging Python expertise to solve complex integrations and reliability issues.

📫 Let's Connect:
[![LinkedIn](https://skillicons.dev/icons?i=linkedin)](https://www.linkedin.com/in/santiagogiraldoalegria)

## Previous Roles
- 🐍 **Senior Python Developer & Team Lead** (2022–Present)  
  Led automation projects for enterprise grant management systems and more.
  
- ⚙️ **Python Backend Engineer** (2021–2022)  
  Built scalable API integrations and workflow automation services.
  
- 👨‍🏫 **Software Engineering Tutor** (2021)  
  Taught programming in national tech training initiative.
  
- 💬 **Software Engineer** (2020)  
  Developed chatbot management platform for public covid information sharing.
